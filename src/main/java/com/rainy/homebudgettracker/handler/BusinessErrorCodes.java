...
public enum BusinessErrorCodes {
    ...
    EXPIRED_JWT_TOKEN(306, UNAUTHORIZED, "Expired JWT token"),
    MISSING_OR_INVALID_REQUEST_BODY_ELEMENT(307, BAD_REQUEST, "Missing or invalid request body element"),
    ...
    RECORD_ASSOCIATED_WITH_ANOTHER_RECORD(404, BAD_REQUEST, "Record is associated with another record"),
    ;
